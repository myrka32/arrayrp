...
function fillHairMenu() {
    hairItem = new UIMenuListItem("Волосы", "Your character's hair.", new ItemsCollection(Data.hairList[currentGender].map(h => h.Name)));
    creatorHairMenu.AddItem(hairItem);

    hairColorItem = new UIMenuListItem("Цвет волос", "Your character's hair color.", new ItemsCollection(hairColors));
    creatorHairMenu.AddItem(hairColorItem);

    hairHighlightItem = new UIMenuListItem("Цвет кончиков волос", "Your character's hair highlight color.", new ItemsCollection(hairColors));
    creatorHairMenu.AddItem(hairHighlightItem);

    eyebrowColorItem = new UIMenuListItem("Цвет бровей", "Your character's eyebrow color.", new ItemsCollection(hairColors));
    ...
    eyeColorItem = new UIMenuListItem("Цвет глаз", "Your character's eye color.", new ItemsCollection(Data.eyeColors));
    ...
    creatorHairMenu.AddItem(new UIMenuItem("Случано", "~r~Randomizes your hair & colors."));
    creatorHairMenu.AddItem(new UIMenuItem("Восстановть", "~r~Resets your hair & colors."));
}
...
// CREATOR MAIN
let creatorMainMenu = new Menu("Редактор", "", new Point(50, 50));
let genderItem = new UIMenuListItem("Пол", "~r~Изменение сбросит настройки.", new ItemsCollection(["Мужской", "Женский"]));
creatorMainMenu.AddItem(genderItem);
creatorMainMenu.AddItem(new UIMenuItem("Родители", "Родители вашего персонажа."));
creatorMainMenu.AddItem(new UIMenuItem("Внешность", "Внешность вашего персонажа."));
creatorMainMenu.AddItem(new UIMenuItem("Особенности кожи", "Особенности кожи вашего персонажа."));
creatorMainMenu.AddItem(new UIMenuItem("Волосы", "Волосы вашего персонажа."));

let angles = [];
for (let i = -180.0; i <= 180.0; i += 5.0) angles.push(i.toFixed(1));
let angleItem = new UIMenuListItem("Вращать", "", new ItemsCollection(angles));
creatorMainMenu.AddItem(angleItem);

let saveItem = new UIMenuItem("Сохранить", "Сохранить все изменения.");
saveItem.BackColor = new Color(13, 71, 161);
saveItem.HighlightedBackColor = new Color(25, 118, 210);
creatorMainMenu.AddItem(saveItem);

let cancelItem = new UIMenuItem("Отмена", "Отменить все изменения.");
...
let creatorParentsMenu = new Menu("Родители", "", new Point(50, 50));
let fatherItem = new UIMenuListItem("Отец", "Отец вашего персонажа.", new ItemsCollection(Data.fatherNames));
let motherItem = new UIMenuListItem("Мать", "Мать вашего персонажа.", new ItemsCollection(Data.motherNames));
let similarityItem = new UIMenuListItem("Наследственность", "0% Мать > 100% Отец", new ItemsCollection(similarities));
let skinSimilarityItem = new UIMenuListItem("Тон кожи", "0% Мать > 100% Отец", new ItemsCollection(similarities));
...
creatorParentsMenu.AddItem(new UIMenuItem("Случано", "~r~Случано."));
creatorParentsMenu.AddItem(new UIMenuItem("Восстановть", "~r~Восстановть."));
...
let creatorFeaturesMenu = new Menu("Внешность", "", new Point(50, 50));
...
creatorFeaturesMenu.AddItem(new UIMenuItem("Случано", "~r~Случано."));
creatorFeaturesMenu.AddItem(new UIMenuItem("Восстановть", "~r~Восстановть."));
...
let creatorAppearanceMenu = new Menu("Особенности кожи", "", new Point(50, 50));
...
creatorAppearanceMenu.AddItem(new UIMenuItem("Случано", "~r~Случано."));
creatorAppearanceMenu.AddItem(new UIMenuItem("Восстановть", "~r~Восстановть."));
...
creatorHairMenu = new Menu("Волосы", "", new Point(50, 50));
fillHairMenu();
